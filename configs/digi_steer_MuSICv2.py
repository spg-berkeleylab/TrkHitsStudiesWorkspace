...
OverlayFull.Parameters = {
    ...
    "Collection_IntegrationTimes": [
        "VertexBarrelCollection", "-0.5", "15.0",
        "VertexEndcapCollection", "-0.5", "15.0",
        "InnerTrackerBarrelCollection", "-0.5", "15.0",
        "InnerTrackerEndcapCollection", "-0.5", "15.0",
        "OuterTrackerBarrelCollection", "-0.5", "15.0",
        "OuterTrackerEndcapCollection", "-0.5", "15.0",
...
ClusterFilter_VBLoose.Parameters = {
    "ThetaRanges": ["0","0.5","1.0","2.2","2.7","3.2",
                    "0","0.5","1.0","2.2","2.7","3.2",
                    "0","0.5","1.0","2.2","2.7","3.2",
                    "0","0.5","1.0","2.2","2.7","3.2",
                    "0","0.5","1.0","2.2","2.7","3.2"],
    "ClusterSize": ["10","6","4","6","10",
                    "9","6","4","6","9",
                    "8","5","4","5","8",
                    "8","5","4","5","8",
                    "8","4","4","4","8"],
...
ClusterFilter_VELoose.Parameters = {
    "ThetaRanges": ["0","0.628","1.256","1.884","2.512","3.2",
                    "0","0.628","1.256","1.884","2.512","3.2",
                    "0","0.628","1.256","1.884","2.512","3.2",
                    "0","0.628","1.256","1.884","2.512","3.2"], 
...
if the_args.writeAll:
    ...
    if the_args.doClusterFilter:
        LCIOWriter_light.Parameters["KeepCollectionNames"]=["VXDBarrelHits", "VXDEndcapHits", "ITBarrelHits", "ITEndcapHits", "OTBarrelHits", "OTEndcapHits", "VXDBarrelHitsRelations", "VXDEndcapHitsRelations", "ITBarrelHitsRelations", "ITEndcapHitsRelations", "OTBarrelHitsRelations", "OTEndcapHitsRelations", "VBPixels_HTF", "VEPixels_HTF", "IBPixels_HTF", "IEPixels_HTF", "OBPixels_HTF", "OEPixels_HTF", "VertexBarrelCollection_CF", "VertexEndcapCollection_CF", "InnerTrackerBarrelCollection_CF", "InnerTrackerEndcapCollection_CF", "OuterTrackerBarrelCollection_CF", "OuterTrackerEndcapCollection_CF"]
    if not the_args.doClusterFilter:
        LCIOWriter_light.Parameters["KeepCollectionNames"]=["VXDBarrelHits", "VXDEndcapHits", "ITBarrelHits", "ITEndcapHits", "OTBarrelHits", "OTEndcapHits", "VXDBarrelHitsRelations_HTF", "VXDEndcapHitsRelations_HTF", "ITBarrelHitsRelations_HTF", "ITEndcapHitsRelations_HTF", "OTBarrelHitsRelations_HTF", "OTEndcapHitsRelations_HTF", "VBPixels_HTF", "VEPixels_HTF", "IBPixels_HTF", "IEPixels_HTF", "OBPixels_HTF", "OEPixels_HTF", "VertexBarrelCollection_HTF", "VertexEndcapCollection_HTF", "InnerTrackerBarrelCollection_HTF", "InnerTrackerEndcapCollection_HTF", "OuterTrackerBarrelCollection_HTF", "OuterTrackerEndcapCollection_HTF"]
